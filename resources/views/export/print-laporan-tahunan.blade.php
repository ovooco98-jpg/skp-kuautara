...
<head>
    ...
    <title>Laporan Tahunan - {{ $laporan->tahun }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="periode">
                PERIODE PENILAIAN: TAHUN {{ $laporan->tahun }}
            </div>
        </div>
        ...
        @if($rencana)
        <!-- Rencana Tahun Depan -->
        <div class="section-title">IV. RENCANA TAHUN DEPAN</div>
        <table class="main-table">
            <thead>
                <tr>
                    <th class="col-no">(1)<br>NO</th>
            ...
            <tbody>
                <tr>
                    <td style="text-align: center; vertical-align: top;">1</td>
                    <td style="vertical-align: top;"><strong>RENCANA TAHUN DEPAN</strong></td>
