...
<head>
    ...
    <title>Laporan Bulanan - {{ $laporan->nama_bulan }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="periode">
                PERIODE PENILAIAN: {{ strtoupper($laporan->nama_bulan) }} TAHUN {{ $laporan->tahun }}
            </div>
        </div>
        ...
        @if($rencana)
        <!-- Rencana Bulan Depan -->
        <div class="section-title">IV. RENCANA BULAN DEPAN</div>
        <table class="main-table">
            <thead>
                <tr>
                    <th class="col-no">(1)<br>NO</th>
            ...
            <tbody>
                <tr>
                    <td style="text-align: center; vertical-align: top;">1</td>
                    <td style="vertical-align: top;"><strong>RENCANA BULAN DEPAN</strong></td>
        ...
        <div class="section-title">V. TARGET YANG TERCAPAI</div>
        <table class="target-table">
            <thead>
                <tr>
                    <th style="width: 5%;">(1)<br>NO</th>
                    <th style="width: 45%;">(2)<br>INDIKATOR</th>
                    <th style="width: 25%;">(3)<br>TARGET</th>
                    <th style="width: 25%;">(4)<br>REALISASI</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td style="text-align: center;">1</td>
                    <td>Total Kegiatan Harian (LKH)</td>
                    ...
                    <td style="text-align: center;">{{ $laporan->total_lkh }} kegiatan</td>
                </tr>
                <tr>
                    <td style="text-align: center;">2</td>
                    <td>Total Durasi Kegiatan</td>
                    <td style="text-align: center;">
                        @if($targetDurasi)
                            {{ $targetDurasi }}
                        @else
                    ...
                    <td style="text-align: center;">{{ number_format($laporan->total_durasi, 1) }} jam</td>
                </tr>
                <tr>
                    <td style="text-align: center;">3</td>
                    <td>Rata-rata Durasi per Kegiatan</td>
                    <td style="text-align: center;">-</td>
                    <td style="text-align: center;">{{ $laporan->total_lkh > 0 ? number_format($laporan->total_durasi / $laporan->total_lkh, 1) : 0 }} jam</td>
                </tr>
            </tbody>
        </table>
