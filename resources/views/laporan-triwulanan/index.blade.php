...
<div>
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Laporan Triwulanan</h1>
            <p class="mt-1 text-sm text-gray-500">Konsolidasi laporan bulanan menjadi laporan triwulanan</p>
        </div>
        <x-button href="{{ route('laporan-triwulanan.create', ['tahun' => $tahun ?? date('Y')]) }}" variant="primary" icon="plus" size="sm">
    ...
    <!-- Filters -->
    <x-card class="mb-6">
        <form method="GET" action="{{ route('laporan-triwulanan.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
            ...
            <div>
                ...
                <select name="triwulan" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
    ...
    <x-card>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Laporan Bulanan</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900">{{ $lap->nama_triwulan }}</div>
                        ...
                        <td class="px-4 py-3 text-center">
                            <span class="text-sm text-gray-900">{{ $lap->laporanBulanan->count() }}</span>
                        </td>
                        <td class="px-4 py-3 text-center">
                        ...
                        <td class="px-4 py-3 text-center">
                            <x-button href="{{ route('laporan-triwulanan.show', $lap->id) }}" variant="primary" size="sm" icon="eye">
                                Lihat
                            </x-button>
                        </td>
                    </tr>
        ...
        <div class="text-center py-12">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900">Tidak ada laporan triwulanan</h3>
            <p class="mt-1 text-sm text-gray-500">Mulai dengan membuat laporan triwulanan baru untuk tahun {{ $tahun ?? date('Y') }}.</p>
            <div class="mt-6">
                <x-button href="{{ route('laporan-triwulanan.create', ['tahun' => $tahun ?? date('Y')]) }}" variant="primary" size="sm">
                    Buat Laporan Triwulanan
                </x-button>
            </div>
        </div>
